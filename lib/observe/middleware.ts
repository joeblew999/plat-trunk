...
//
// ⚠ PII: Never put personally-identifiable information (email, name, tokens) in
//   log fields. If needed, use a separate `pii.*` envelope so it can be stripped
//   before export / long-term retention.
