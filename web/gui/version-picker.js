...
export class CadVersionPicker extends LitElement {
  ...
  constructor() {
    ...
    this._github = 'https://github.com/joeblew999/plat-trunk';
    this._current = '?';
    this._isLocal = false;
    this._loaded = false;
  }
  ...
  async _fetchData() {
    try {
      ...
      this._github = manifest.github || this._github;
      this._loaded = true;
      ...
      <div class="dropdown dropdown-bottom">
        ...
        ${this._loaded && this._versions.length > 0 ? html`
          <ul tabindex="0" class="dropdown-content menu bg-base-200 rounded-box z-50 w-64 p-2 shadow-xl text-xs">
            ...
            <li><a href=${this._github + '/releases'} target="_blank">GitHub Releases</a></li>
          </ul>
        ` : ''}
      </div>
    `;
