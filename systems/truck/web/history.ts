import { cadCommand, reconcile, moduleRouter, getSchema } from './state';
...
class CadDocumentManager {
    ...
    declare _replayInProgress: boolean;
    declare _suppressChangeReplay: boolean;
    declare _localOpCount: number;
    declare _lastSavedOpIndex: number;
    ...
    async record(type, params = {}, meta: any = {}) {
