...
# Output tells you the preview URL, e.g.: https://v0-5-0-truck-cad.gedw99.workers.dev
...
**Version validation:**
```sh
task truck:version:current                               # local: v0.5.0
curl -sf https://cad.ubuntusoftware.net/api/health       # {"version":"0.5.0"}
